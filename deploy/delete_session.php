  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Delete Session</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    if ($_POST['session_id']) {
        try {
            ...
            $stmt->bindValue(':session_id', $_POST['session_id'], PDO::PARAM_INT);
            $stmt->execute();
                ...
                $data=[
                    ...
                    "heading" => "Success",
                    "class" => "bg-success",
                    "message" => "The Session has been deleted successfuly"
                ];
        ...
        $data=[
            ...
            "heading" => "Error",
            "class" => "bg-danger",
            "message" => "The Session could not deleted successfuly"
        ];
    } 
