    ...
    if ($_POST['session_id']) {
        try {
            ...
            if ($result) {
                ...
                $stmt->bindParam(':session_id', $result['session_id'], PDO::PARAM_INT); // Use the fetched session_id
                ...
                $data=[
                    ...
                    "heading" => "Success",
                    "class" => "bg-success",
                    "message" => "The Session has been ended successfuly"
                ];
            } else {
        ...
        $data=[
            ...
            "heading" => "Error",
            "class" => "bg-danger",
            "message" => "The Session could not ended successfuly"
        ];
    } 
    ...
    <section class="content" id="success">
      ...
      <div class="card ml-auto mr-auto" style="max-width: 800px;">
        ...
        <div class="card-footer"><a href="index.php" class="btn btn-primary float-left">Go to Dashboard</a>
          &nbsp;<a href="session.php" class="btn btn-primary float-right">Go to Session</a>
        </div>
        <!-- /.card-footer-->
      </div>
      <!-- /.card -->
